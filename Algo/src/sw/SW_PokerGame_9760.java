...
public class SW_PokerGame_9760 {
	...
	static String[] result = {"Straight Flush", "Four of a Kind", "Full House", "Flush", "Straight",
	...
	public static void main(String[] args) throws Exception {
		...
		for (int t = 1; t <= T; t++) {
			...
			rankCnt = new int[14];  //초기화 //0 dummy
			...
			//foker 의 결정에 필요한 조건들을 하나씩 완성  true / false
			boolean Flush = false;
			for (int i = 0; i < 4; i++) {
				if(suitCnt[i] == 5) {
					Flush = true;
...
//			9. High card : 1~8번에 해당하지 않는다.  
			...
			if(Flush && Straight) System.out.println("#" + t + " " + "Straight Flush");
			else if(FourOfaKind) System.out.println("#" + t + " " + "Four of a Kind");
			else if(ThreeOfaKind && OnePair) System.out.println("#" + t + " " + "Full House");
			else if(Flush) System.out.println("#" + t + " " + "Flush");
			else if(Straight) System.out.println("#" + t + " " + "Straight");
			else if(ThreeOfaKind) System.out.println("#" + t + " " + "Three of a kind");
			else if(TwoPair) System.out.println("#" + t + " " + "Two pair");
			else if(OnePair) System.out.println("#" + t + " " + "One pair");
